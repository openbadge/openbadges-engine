 ...
 */
function _createBadge(data, openBadges, storage, host, callback) {
    /**
...
function awardBadgeManually(openBadges, storage) {
    return function (req, res) {
        _createBadge(req.body, openBadges, storage, req.headers.host, function (err, url) {
...
function awardBadge(openBadges, storage) {
    return function (req, res) {
        ...
        _createBadge(payload, openBadges, storage, req.headers.host, function (err, url) {
            if (err) { console.log(err); }
